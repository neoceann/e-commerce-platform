...
REST API для управления интернет-магазином бытовой техники:
- HTTP сервис с CRUD для товаров, категорий, клиентов, поставщиков
- Отдельный gRPC сервис для регистрации и JWT-аутентификации
...
1. Если запущено через Docker:
`make docker-down`

2. Если запущено вручную:
`^C в обоих терминалах`
